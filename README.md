...
This repository contains the source code of the agent plugin for the DynamoDB integration.

Learn more about the DynamoDB integration [here](https://docs.superblocks.com/integrations/connect-integrations/dynamodb).
